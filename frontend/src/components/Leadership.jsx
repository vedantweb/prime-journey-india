      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <Reveal delay={0.2} className="mt-12 flex justify-center">
          <Link
            ...
            to="/about"
            className="btn-arrow group flex items-center gap-2 rounded-full border border-ocean/20 px-7 py-3 font-body text-sm font-bold text-ocean transition-colors duration-300 hover:border-ocean hover:bg-ocean hover:text-white"
          >
