      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <SectionHeading
            ...
            title={<>Discover <span className="font-editorial font-normal italic text-saffron">India</span></>}
            sub="Eight corners of the country we know by heart — each with its own light, flavour and pace."
          />
          <Reveal delay={0.2} className="shrink-0">
            <p className="max-w-[220px] font-editorial text-lg italic leading-snug text-ink/50 md:text-right">
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-3 p-6">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-white/80 opacity-0 transition-[opacity,transform] duration-500 [transform:translateY(6px)] group-hover:opacity-100 group-hover:[transform:translateY(0)]">
                      {d.tagline}
                    </p>
                  </div>
