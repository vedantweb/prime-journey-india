      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start gap-10 px-5 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
        ...
        <Reveal delay={0.15} className="w-full max-w-xl">
          <div className="relative rotate-[-2deg]">
            <div
              className="absolute -left-3 top-6 z-10 h-8 w-24 rotate-[-38deg] rounded-sm bg-sand/70 shadow-sm backdrop-blur-[1px]"
              aria-hidden="true"
            />

            <div
              className="absolute -right-4 top-10 z-10 h-8 w-24 rotate-[32deg] rounded-sm bg-sand/70 shadow-sm backdrop-blur-[1px]"
              aria-hidden="true"
            />

            <div
              data-testid="torn-paper-offer"
              className="torn-paper relative px-8 py-12 text-center sm:px-14 sm:py-14"
            >
              <p className="text-[11px] font-bold uppercase tracking-[0.4em] text-coral">
                {tornOffer.kicker}
              </p>
